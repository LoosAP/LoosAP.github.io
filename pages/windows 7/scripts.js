...
function aprilFoolsCountdown() {
  ...
  if (today.getMonth() == 3 && today.getDate() == 1) {
    $("#aprilCountdown").html(
      "Today is April Fools' Day!!! It's time to prank someone! <strong>&#127880;&#128520;&#127881;</strong>"
    );
    $("#aprilCountdown").show();
  } else {
    ...
    if (daysleft < 10 && daysleft > 0) {
      $("#aprilCountdown").html(
        "Only " +
          daysleft +
          " days until April Fools' Day! <strong>&#127880;&#128520;&#127881;</strong>"
      );
      $("#aprilCountdown").show();
    }
  }
